   ...
   <>
        ...
        <div className="modal-overlay flex items-center justify-center fixed bg-black bg-opacity-50 top-0 left-0 w-full h-full">
          <div className="modal" ref={modalRef}>
           ...
           <Svg className='ml-auto mb-2  absolute smOnly:right-3 md:right-6 cursor-pointer hover:stroke-yellow ' id={'icon-cross'} size={'24px'} stroke={'#54ADFF'} onClick={onCloseModal}/>
              <div>{children}</div>
            </div>
          </div>
        </div>,
