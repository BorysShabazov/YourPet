...
const ButtonAddToFavorites = ({ isAddToFavorite, addToFavorites }) => {
  return (
    <button
      ...
      className=" md:w-32 md:h-10 smOnly:w-auto smOnly:h-10 px-5 py-2 bg-blue hover:bg-gradient-to-l from-blue to-lightBlue rounded-3xl justify-center items-center gap-2 inline-flex text-stone-50 text-base font-bold font-['Manrope'] tracking-wide"
    >
